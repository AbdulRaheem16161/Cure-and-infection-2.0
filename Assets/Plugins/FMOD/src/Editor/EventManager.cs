...
namespace FMODUnity
{
    ...
    public class EventManager : MonoBehaviour
    {
        ...
        private static string UpdateCache()
        {
			...
			// CUSTOM CHANGE: If there are no bank files just ignore for now so i dont get spammed with error logs, REVERT ONCE BANKS ARE BUILT
			...
			{
				Debug.Log("FMOD: No banks found in " + defaultBankFolder);
				return null;
			}
