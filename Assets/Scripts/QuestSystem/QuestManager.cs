...
public class QuestManager : MonoBehaviour
{
	...
	public InventoryHandler playerInventory; //test representation for player inventory
	...
	/// <summary>
	/// will need proper way to grab player inventory from a GameManager or similar etc...
	/// </summary>

	public void Start()
	{
		playerInventory = TestInventoryManager.Instance.playerObj.GetComponent<InventoryHandler>();
	}
