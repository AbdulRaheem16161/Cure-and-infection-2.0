...
public class QuestDefinition : ScriptableObject
{
	...
	public List<InventoryItem> questItemsNeeded = new(); //type can be specified later on in dev
	...
	public List<InventoryItem> questRewards = new(); //type can be specified later on in dev
